...
# Debug:
# indicator_variable_metrics <- metrics_data[[3]]
for(indicator_variable_metrics in metrics_data) {
  ...
  indicator_summary <- indicator_variable_metrics$meta$summary
  ...
  cat("### Data Summary\n\n")
  table <- summarize_indicator_summary(indicator_summary) |> kable()
  print(table)

  cat("### Milestone/Distance Metrics\n\n")
  if (indicator_variable_metrics$meta$data_type == "numeric") {
    table <- indicator_variable_metrics$meta$milestone_summary |> kable()
    print(table)
